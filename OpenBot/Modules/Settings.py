...
import FileManager, UIComponents, Movement, OpenLib, OpenLog, Hooks, Data, eXLib, ChannelSwitcher
...
class SettingsDialog(ui.ScriptWindow):
	...
	def BuildWindow(self):
		...
		self.TabWidget = UIComponents.TabWindow(10,30,300-20,370-40,self.Board,['General', 'Channels'])
		...
		self.channelsTab = self.TabWidget.GetTab(1)
	...
	def SaveSettings(self):
		...
		FileManager.WriteConfig("timeAfterDead", str(7))
